package com.aamend.hadoop.mapreduce.index.service;

import java.io.File;
import java.util.HashMap;

import com.aamend.hadoop.mapreduce.index.job.*;
...
import com.aamend.hadoop.mapreduce.index.fileInput.IndexFileInputFormat;
